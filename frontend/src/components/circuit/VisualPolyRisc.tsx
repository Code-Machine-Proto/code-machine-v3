  ...
  return (
    ...
    >
      ...
      <ObscureMemory name={['Mémoire', "d'instructions"]} class="fill-green-700" x={313} y={70}>
        ...
        <text x={165} y={182} dominant-baseline="middle" text-anchor="end" fill="black">
          data_in
        </text>
      </ObscureMemory>
      ...
      >
        ...
        <text x={165} y={122.5} dominant-baseline="middle" text-anchor="end" fill="black">
          A
        </text>
        <text x={165} y={267.5} dominant-baseline="middle" text-anchor="end" fill="black">
          B
        </text>
      </ObscureMemory>
      <ObscureMemory
      ...
      >
        ...
        <text x={165} y={190} dominant-baseline="middle" text-anchor="end" fill="black">
          data_out
        </text>
      </ObscureMemory>
      ...
      <g>
        <rect
          ...
          stroke-width="2"
        />
        <text x={154} y={102} text-anchor="middle" dominant-baseline="middle" class="text-xl circuit-label">
          +1
        </text>
      </g>
