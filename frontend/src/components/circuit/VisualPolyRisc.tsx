...
export default function VisualPolyRisc(props: VisualProps) {
  ...
  const nop = () =>
    ls() === 8 || opTwoReg() || opThreeReg() || load() || store() || loadI();
  ...
  return (
    ...
    >
      ...
      <use
        href='#mux-reg'
        class={
          opTwoReg() || opThreeReg() || load() || loadI() ? 'fill-red-500' : ''
        }
      />
      ...
      <use
        href='#ir-rsrc1'
        class={
          opTwoReg() || opThreeReg() || load() || store() ? 'fill-red-500' : ''
        }
      />
      <use
        href='#ir-rsrc2'
        class={opThreeReg() || store() ? 'fill-red-500' : ''}
      />
      <use href='#ir-pc' class={branching() ? 'fill-red-500' : ''} />
      <use
        href='#reg-A'
        class={opTwoReg() || opThreeReg() ? 'fill-red-500' : ''}
      />
      ...
      <Multiplexer
        ...
        x={652}
        y={47}
        isActivated={opTwoReg() || opThreeReg() || load() || loadI()}
      />
      ...
      <ALU
        ...
        y={100}
        hasNz={true}
        isActivated={opTwoReg() || opThreeReg()}
      />
      ...
      <ObscureMemory
        ...
        controlName='wr_reg'
        isWritable={opTwoReg() || opThreeReg() || load() || loadI()}
      >
        <text x={5} y={35} dominant-baseline='middle' fill='black'>
          data_in
        </text>
        <text x={5} y={201} dominant-baseline='middle' fill='black'>
          rdst
        </text>
        <text x={5} y={238} dominant-baseline='middle' fill='black'>
          rsrc1
        </text>
        <text x={5} y={275} dominant-baseline='middle' fill='black'>
          rsrc2
        </text>
        <text
          x={165}
      ...
      <ObscureMemory
        ...
        isWritable={store()}
      >
        <text x={5} y={132.5} dominant-baseline='middle' fill='black'>
          addr
        </text>
        <text x={5} y={264} dominant-baseline='middle' fill='black'>
          data_in
        </text>
        <text
          x={165}
      ...
      <RegisterBox
        ...
        x={134.5}
        y={137.5}
        isActivated={nop() || branching()}
        registerSize={REGISTER_12_BIT}
      />
      <RegisterBox
        name='IR'
      ...
      <circle
        ...
        cy='170'
        r='5'
        class={fetch() || nop() ? 'fill-red-500' : 'fill-main-600'}
      />
      <circle
        cx='616'
        cy='170'
      ...
      <circle
        ...
        cy='217'
        r='5'
        class={opThreeReg() || store() ? 'fill-red-500' : 'fill-main-600'}
      />
