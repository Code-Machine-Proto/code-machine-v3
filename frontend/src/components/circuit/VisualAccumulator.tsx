  ...
  return (
    ...
    >
      ...
      <ObscureMemory
        ...
        isWritable={store()}
      >
        <text x="5" y="82.5" dominant-baseline="middle" fill="black">
          data_in
        </text>
        <text x="5" y="222" dominant-baseline="middle" fill="black">
          addr
        </text>
        <text x="165" y="243" text-anchor="end" dominant-baseline="middle" fill="black">
          data_out
        </text>
      </ObscureMemory>
      ...
      <g>
        <rect
          ...
          stroke-width="2"
        />
        <text x="139" y="68" text-anchor="middle" dominant-baseline="middle" class="text-xl circuit-label">
          +1
        </text>
      </g>
