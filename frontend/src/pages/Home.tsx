  ...
  return (
    <div class="relative flex flex-col items-center justify-center h-screen px-4 overflow-hidden">
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse at 50% 40%, rgba(59, 130, 246, 0.06) 0%, transparent 70%)' }}
      />
      ...
      <div class="relative z-10 flex flex-col items-center gap-12">
        ...
        <div class="text-center animate-fade-up">
          ...
          <p class="text-main-600 text-sm tracking-wide">Simulateur de chemin de données — INF1600</p>
        </div>
