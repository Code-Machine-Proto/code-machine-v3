...
const processors = [
  {
    ...
    name: 'Accumulateur',
    description:
      'Processeur simple — 9 instructions, registre accumulateur unique',
    icon: 'ACC',
    color: 'blue',
    accent: '#3b82f6',
  },
  {
    ...
    description:
      'Etendu — 20 instructions, adressage indirect via le registre MA',
    icon: 'MA',
    color: 'amber',
    accent: '#f59e0b',
  },
  {
    ...
    name: 'PolyRisc',
    description:
      "Processeur RISC — 32 registres, drapeaux, jeu d'instructions riche",
    icon: 'RISC',
    color: 'emerald',
    accent: '#10b981',
  },
...
const colorMap: Record<
  string,
  { border: string; iconBg: string; hoverBg: string }
> = {
  blue: {
  ...
  return (
    <div class='relative flex flex-col items-center justify-center h-screen px-4 overflow-hidden'>
      ...
      <div class='relative z-10 flex flex-col items-center gap-12'>
              ...
              return (
                ...
                >
                  ...
                  <div class='flex items-center gap-3 mb-3'>
                    <div
                      class={`w-10 h-10 rounded-lg border flex items-center justify-center text-xs font-bold font-mono ${c.iconBg}`}
                    >
                      {p.icon}
                    </div>
                  ...
                  <p class='text-main-500 text-xs leading-relaxed'>
                    {p.description}
                  </p>
                  ...
                  <div class='mt-4 flex items-center gap-1.5 text-main-600 group-hover:text-main-400 transition-colors text-xs'>
                    <span>Ouvrir</span>
                    <svg
                      class='w-3 h-3 translate-x-0 group-hover:translate-x-1 transition-transform'
                      fill='none'
                      stroke='currentColor'
                      viewBox='0 0 24 24'
                    >
        ...
        {/* Footer */}
        <p
          class='text-main-700 text-xs tracking-wider animate-fade-up'
