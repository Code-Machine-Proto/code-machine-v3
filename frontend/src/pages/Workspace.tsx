...
export default function Workspace() {
  ...
  const [memCollapsed, setMemCollapsed] = createSignal(false);
  const [editorCollapsed, setEditorCollapsed] = createSignal(false);
  const [sidebarCollapsed, setSidebarCollapsed] = createSignal(false);
  const registersExpand = () => memCollapsed() && !regCollapsed();
              ...
              <>
                ...
                >
                  <MemoryView
                    ...
                    onToggleCollapsed={() => setMemCollapsed((c) => !c)}
                  />
                </div>
              </>
            </Show>
